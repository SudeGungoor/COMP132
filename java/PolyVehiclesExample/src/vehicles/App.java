...
public class App {
	...
	public static void main(String[] args) {
		...
		// instanceof operator is used to test whether the object (at left) is an instance of 
		// the specified type (at right) (e.g., class or subclass).
		// It returns either true or false. 

		if (v3 instanceof Car) // instanceof operator
			System.out.println("v3 is an instance of Car"); 
		else
		    System.out.println("v3 is NOT an instance of Car"); 
