...
public class Test {
	...
	public static void main(String[] args) {
		...
		ExecutableFile player = new ExecutableFile("vmplayer.exe", 160000, false, "Windows on Intel", new byte[1]);
		
		File music = new DataFile("Walking On Air.mp3", 350000, true, "mp3", player, new boolean[1]);
		
		File movie = new DataFile("Up.mkv", 1500000, false, "mkv", player, new boolean[1]);
